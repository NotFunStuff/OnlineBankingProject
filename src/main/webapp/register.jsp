                ...
                <div class="login-form">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <span><small>Should be more than 6 letters or number with at least one uppercase character</small></span>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-check-inline">
                                ...
                                <div class="radio">
                                    <label for="radio1" class="form-check-label">
                                        <input type="radio" id="radio1" name="time" value="User"
                                            class="form-check-input">User
                                    </label>
                                </div>
                                <div class="radio">
                                    <label for="radio2" class="form-check-label">
                                        <input type="radio" id="radio2" name="time" value="Business"
