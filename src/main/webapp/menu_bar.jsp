				...
				<ul class="nav navbar-nav">
					...
					<li class="menu-item-has-children dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							...
							<li><i class="fa fa-cutlery"></i><a href="/class_list">Restaurant</a></li>
							<li><i class="fa fa-shopping-cart"></i><a href="/class_list">Clothes</a></li>
							<li><i class="fa fa-lightbulb-o"></i><a href="/class_list">Electronics</a></li>
						</ul></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
