								...
								<form action="/class_edit_{classId}" id="myForm1" method="POST"
									...
									<div class="row form-group">
										...
										<div class="col col-md-9">
											<p class="form-control-static">Loan or Save</p>
										</div>
									</div>
									<div class="row form-group">
										<div class="col col-md-3">
											<label for="select" class=" form-control-label">Interest
												(%)</label>
										</div>
										<div class="col-12 col-md-9">
											<input type="number" name="interest" placeholder="x.x"
												value="x.x" class="form-control">
										</div>
									</div>
									<div class="row form-group">
										<div class="col col-md-3">
											<label for="select" class=" form-control-label">Term
												(months)</label>
										</div>
										<div class="col-12 col-md-9">
											<input type="number" name="interest" placeholder="x"
